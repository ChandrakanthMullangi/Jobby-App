...
class Jobs extends Component {
  ...
  onChangeSalaryRange = newSalaryRange => {
    this.setState({minimumSalary: newSalaryRange}, this.getJobs)
  }

  onChangeEmploymentType = newEmploymentType => {
    this.setState(
      prev => ({employmentType: [...prev.employmentType, newEmploymentType]}),
      this.getJobs,
    )
  }
