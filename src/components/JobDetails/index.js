...
class JobDetails extends Component {
  state = {apiStatus: '', jobData: {}, similarJobsData: []}
  ...
  getJobDetails = async () => {
    ...
    if (response.ok) {
      ...
      const updatedJobDetailsData = this.getJobDetailsFormattedData(
        fetchedData.job_details,
      )
      const updatedSimilarJobsData = fetchedData.similar_jobs.map(data =>
        this.getSimilarJobsFormattedData(data),
      )
